...
public class MonitorController {
   ...
   public ResponseEntity<String> deleteMonitorById(@PathVariable int id) throws SQLException {
      ...
      return ResponseEntity.ok("Monitor successfully deleted");
   }
